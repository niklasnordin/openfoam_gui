"""
Template for buoyantPimpleFoam solver.
Transient buoyant, compressible, turbulent flow (PIMPLE algorithm).
"""
from __future__ import annotations
from shared_dicts import *

SOLVER_NAME = "buoyantPimpleFoam"
SOLVER_DESCRIPTION = "Transient buoyant, compressible, turbulent flow (PIMPLE)"
...
CONTROL_DICT = {
    ...
    "groups": {
        "Time Control": [
            ("Application", "application", "buoyantPimpleFoam", "str", None),
            ...
            ("End Time", "endTime", 10.0, "float", (0, 1e9)),
        ...
        "Write Control": [
            ...
            ("Write Interval", "writeInterval", 0.5, "float", (1e-12, 1e9)),
